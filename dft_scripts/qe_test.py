...
nk       = int(os.getenv("NK")) 
degauss  = float(os.getenv("DEGAUSS"))   # in rare case, if use smearing for insulator, set this 0.0001
...
for value in values_to_test:
    ...
    input_data_scf = {    
        ...
        'electrons': {
            'conv_thr': conv_thr,
            'mixing_mode': 'plain',  # Default: 'plain' (Broyden mixing)
