...
def train(accelerator, model, writer, train_loader, optimizer, scheduler, loss_func, config, logger):
    ...
    for epoch in range(1, config['epochs']+1):
        ...
        for batch_idx, (inputs, target, _) in enumerate(train_loader):
            ...
            # Wu: The next line is equivalent to explicitly calling: output = model.forward(atom_fea, nbr_fea, nbr_fea_idx, crystal_atom_idx)
...
def main():
    ...
    dataset = TrainCIFData(root_dir      = config['root_dir'],
